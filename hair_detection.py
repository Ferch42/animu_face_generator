...
def hair_color(shapes, fname,mask):
    ...
    mask = mask[int(shapes.part(20).y-(shapes.part(33).y - shapes.part(27).y)*1.65): int(shapes.part(20).y - (shapes.part(33).y - shapes.part(27).y)/4), int(shapes.part(0).x):int(shapes.part(16).x)]
    img = img[int(shapes.part(20).y-(shapes.part(33).y - shapes.part(27).y)*1.65): int(shapes.part(20).y - (shapes.part(33).y - shapes.part(27).y)/4), int(shapes.part(0).x):int(shapes.part(16).x)]
...
def get_hair_mask(fname):
    ...
    # Crop to get hair
    img = cv2.imread(fname)
    img = img[int(shapes.part(20).y-(shapes.part(33).y - shapes.part(27).y)*1.5): int(shapes.part(20).y - (shapes.part(33).y - shapes.part(27).y)/4), int(shapes.part(0).x):int(shapes.part(16).x)]
